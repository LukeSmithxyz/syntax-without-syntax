...
It should be said that while Optimality Theory is still partially controversial, especially for use in syntax, I employ it here as a mere shorthard for the presumably much more complex computation performed in actually-existing neural nets, for more details, see \textcite{prince97}.
...
\begin{center}
\begin{tableau}{c|c}
	\inp{}	\const{\initphi}	\const{\finphi}
...
\begin{figure}
	...
	\end{tabular}
	\end{center}
	\caption{All theoretically possible word orders and parses}
\end{figure}
...
We might expect a language (i.e. ordering of constraints) that favors SVO clauses to also prefer SV instransitive clauses, also that is not a logical necessity, as languages such as Spanish indicate.
...
This software package can be fed tableaux of constraints, candidates and their violations and will determine what possible constrain orders are consistent to produce the given candidates.
