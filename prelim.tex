...
Indeed, with some introspection, it should be clear that \emph{any} theory in which syntactic constituents are ordered before and without reference to the prosodic tendencies will necessarily generate a surfeit of possible prosodic grammars.
...
There are a set of syntactic parameters a child must learn, and there is a non-overlapping set of syntactic rules and parameters to be learned.

But in this new conception however, not only are prosody and syntax ``the same,'' but they are mutually reinforcing.
